...
const Contact = ({ data }) => {
   //const [url, setUrl] = useState('mailto:pratiksutar1901@gmail.com?subject=subject&body=body');
   ...
   const handleClick = (e) => {
      e.preventDefault();
      window.open(`mailto:pratiksutar1901@gmail.com?subject=${subject}&body=${name}: ${message}`);
   }
